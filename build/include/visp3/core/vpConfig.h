...
#define VISP_SCENES_DIR "/home/predmach/visp-ws/visp/build/data/wireframe-simulator;/usr/local/share/visp-3.2.0/data/wireframe-simulator"

// Defined the path to the robot's arms 3D model used by the robot simulators
#define VISP_ROBOT_ARMS_DIR "/home/predmach/visp-ws/visp/build/data/robot-simulator;/usr/local/share/visp-3.2.0/data/robot-simulator"

// Defined if Ogre3d is available.
#define VISP_HAVE_OGRE

// Defined if Ogre3d plugins.cfg is available.
#define VISP_HAVE_OGRE_PLUGINS_PATH "/home/predmach/visp-ws/visp/build/data/ogre-simulator;/usr/local/lib/visp/data/ogre-simulator"

// Defined if Ogre3d resources.cfg is available.
#define VISP_HAVE_OGRE_RESOURCES_PATH "/home/predmach/visp-ws/visp/build/data/ogre-simulator;/usr/local/share/visp-3.2.0/data/ogre-simulator"
